...
const ProductCard = React.memo(function ProductCard({ product, categoryName }) {
  ...
  <div className="bg-black/60 backdrop-blur-md px-6 py-3 rounded-2xl shadow-lg shadow-black/40">
    <h3 className="text-white font-bold text-2xl sm:text-3xl tracking-wide">
      {product.name}
    </h3>
  </div>
</div>
  ...
  return (
    <>
      ...
      <div className="bg-background text-white">
        ...
        <section
          className="section-padding py-16 sm:py-24 bg-[url('/background/background.jpg')] bg-repeat bg-center"
        >
          <motion.div
          ...
          {visibleCount < products.length && (
            <div className="text-center mt-16">
              <Button
                onClick={loadMore}
                size="lg"
                className="orange-gradient text-white font-bold uppercase tracking-wider"
              >
                Load More
              </Button>
            </div>
